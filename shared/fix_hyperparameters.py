"""
The difference between this file and hyperparameters_mRMR.py is that it scores against continuous targets (i.e log10mic and log10hc50). This is more consistent for the rest of the pipeline.
"""
