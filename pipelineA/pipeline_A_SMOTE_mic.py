...
- pipeline_A_SMOTE_confusion_mic.png
...
INPUT_FILE = "lasso_pipeline_A_MIC_features.csv"
...
def main():
    ...
    ax.set_title("Pipeline A - MIC (SMOTE)", fontsize=14)
    ax.set_xlabel("Predicted Class", fontsize=14)
    ax.set_ylabel("True Class", fontsize=14)
    fig.tight_layout()
    #out = "pipeline_C_confusion_hc50.png"
    out = "pipeline_A_SMOTE_confusion_mic.png"
